...
from scanner_core.indicators import (
...
from scanner_core.watchlist import is_stable, is_volatile, ALL_STOCKS, STABLE_STOCKS
...
def _store_state(ticker: str, price: float, indicators: dict,
    ...
    if total <= 0 and indicators and isinstance(indicators, dict):
        try:
            from scanner_core.scoring import score_from_available_data
            rsi = 0.0
            rvol = 0.0
            rsi_data = indicators.get("rsi", {})
