...
from quant.stop import StopRequested
...
class RecapJob:
    ...
    params: dict
    deliver: Callable[
        [object | None, str | None], Awaitable[None]
    ]  # async (payload, error) -> None
...
async def recap_queue_worker(
    ...
    run_recap, run_market, run_watchlist_recap: functions that return recap payloads
    """
    if _recap_queue is None:
